...
exports.AddressesModule = AddressesModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([address_model_1.Address]), firms_module_1.FirmsModule],
        controllers: [addresses_controller_1.AddressesController],
        providers: [addresses_service_1.default, geocoding_service_1.GoogleGeocodingService],
    })
], AddressesModule);
